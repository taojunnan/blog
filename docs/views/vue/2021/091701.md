...
由于高德地图[所有天气现象表](https://lbs.amap.com/api/webservice/guide/tools/weather-code)分类很多，不可能一个天气一个图标，所以将常见的天气分类如下  

![分类图片](https://s2.loli.net/2022/03/26/rwpbFOERk6gyNZD.png)  
